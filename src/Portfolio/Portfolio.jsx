...
export const Portfolio = () => (
  <div className="container-fluid project-grid">
    ...
    <div className="row">
      <div className="col">
        <a href="https://brennan64.github.io/weather-app/" data-testid="portfolio-link-weather-app">
        ...
        <a
          ...
          data-testid="portfolio-link-regex-tutorial"
        >
      ...
      <div className="col">
        <a
          ...
          data-testid="portfolio-link-sporting-event-finder"
        >
          <img src={sportsFinder} alt="sports finder, a group project that uses multiple apis." />
        </a>
        <a href="https://brennan64.github.io/CodingQuiz/" data-testid="portfolio-link-coding-quiz">
      ...
      <div className="col">
        <a
          ...
          data-testid="portfolio-link-team-profile-generator"
        >
          <img
            src={teamProfGen}
        ...
        <a href="https://frozen-bayou-00211.herokuapp.com/" data-testid="portfolio-link-tech-blog">
